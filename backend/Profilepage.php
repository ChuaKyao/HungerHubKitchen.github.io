...
<body class="body-fixed">
    ...
    <div id="viewport">
        <div id="js-scroll-content">
            <section class="profilepage section" style="background-image: url(images/booktable-img.png);">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="user">
                                ...
                                <p class="address"><i class="uil uil-location-point"></i><span><?php if ($fetch_profile['address'] == ''){echo 'please enter your address!';}else{ echo $fetch_profile['address']; }; ?></span></p>
